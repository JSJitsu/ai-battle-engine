...
class GameEngine {
    ...
    createGameFromMap (mapFilePath) {
        let buffer = fs.readFileSync(mapFilePath), Game = this.getGame(), game;
    ...
    planAllGames (originalUsers) {
        ...
        let me = this, users = originalUsers.slice(), maxUsersPerTeam = me.configs.maxUsersPerTeam, boardSize = me.configs.boardSize, userLookup = {}, games = [], numberOfGames = 0, alternateTeams = [], gameIndex = 0, map, game, currentGameIndex = 0, thisGame, thisTeam, nextUserIndex, nextUser;
    ...
    pickMap () {
        let dir = __dirname + "/lib/maps/", maps = [];
