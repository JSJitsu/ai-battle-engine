let Hero = (distanceFromTop, distanceFromLeft, name, team) => {
    this.id = undefined;
...
Hero.prototype.killedHero = (otherHero) => {
...
Hero.prototype.healDamage = (amount) => {
    ...
    // Stores stats
    let healthReceived = this.health - startingHealth;
...
Hero.prototype.captureMine = (diamondMine, healthCost) => {
...
Hero.prototype.loseMine = (diamondMine) => {
