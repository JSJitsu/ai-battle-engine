...
Board.prototype.initializeBoard = () => {
    for (let i=0; i<this.lengthOfSide; i++) {
        this.tiles.push([]);
        for (let j=0; j<this.lengthOfSide; j++) {
...
Board.prototype.validCoordinates = (distanceFromTop, distanceFromLeft) => {
...
Board.prototype.getTileNearby = (distanceFromTop, distanceFromLeft, direction) => {
