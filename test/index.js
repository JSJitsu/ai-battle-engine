...
let Board = require('../lib/game_classes/Board.js');
let DiamondMine = require('../lib/game_classes/DiamondMine.js');
let Game = require('../lib/game_classes/Game.js');
let HealthWell = require('../lib/game_classes/HealthWell.js');
let Hero = require('../lib/game_classes/Hero.js');
let Impassable = require('../lib/game_classes/Impassable.js');
let Unoccupied = require('../lib/game_classes/Unoccupied.js');
chai.use(spies);
